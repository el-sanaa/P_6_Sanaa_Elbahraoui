...
exports.nameValidator = [ // Valider le nom de la sauce'
  validate({
    validator: 'isLength',
...
exports.descriptionValidator = [ //  Valider la decription de la sauce
  validate({
    validator: 'isLength',
    arguments: [10, 150],
...
exports.pepperValidator = [ // Valider le principal ingrédient de la sauce
  validate({
    validator: 'isLength',
  ...
  validate({
    validator: 'isAlphanumeric', // Ne contient que des caractères alphanumériques
